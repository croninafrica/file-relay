...
.panel{animation-duration:.24s}.panel+.panel{animation-delay:.04s}@keyframes card-enter{from{opacity:.72;transform:translateY(7px) scale(.997)}to{opacity:1;transform:translateY(0) scale(1)}}
